...
class EdgeTTSService:
    ...
    def get_voice(
        ...
        if lang_code in ALL_VOICES:
            ...
            return default[0] if isinstance(default, list) else str(default)

        # Fallback to English
        logger.warning("Language %s not found, using English", language)
    ...
    async def synthesize(
        ...
        try:
            ...
            logger.info("Edge TTS: Generated %s bytes of audio", len(audio_bytes))
