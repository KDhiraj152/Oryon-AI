...
class IndicTrans2:
    ...
    # Reverse mapping
    CODE_TO_LANG: ClassVar[dict] = {v: k for k, v in LANG_CODES.items()}
    ...
    def __init__(self, model_id: str | None = None, device: str | None = None):
        ...
        logger.info("IndicTrans2 initialized: %s on %s", self.model_id, self.device)
    ...
    def _load_model(self):
        ...
        logger.info("Loading IndicTrans2 model: %s", self.model_id)
        ...
        try:
            ...
            logger.debug("Memory coordinator not available for IndicTrans2: %s", e)
            coordinator = None
        ...
        try:
            ...
            logger.info("IndicTrans2 model loaded on %s (M4 optimized)", self.device)
            ...
            logger.error("Failed to load IndicTrans2: %s", e)
...
def get_translator() -> IndicTrans2:
    """Get or create translator singleton (with memory coordination)."""
