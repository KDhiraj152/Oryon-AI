...
class SentencePipeline:
        ...
        for i, sentence in enumerate(sentences):
            ...
            for stage in stages:
                ...
                try:
                    ...
                    logger.error("Stage %s failed for sentence %s: %s", stage, i, e)
    ...
    async def _translate_sentence(
        ...
        from backend.ml.translate import get_translator
