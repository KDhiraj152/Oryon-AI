    ...
    async def _document_chain_collaboration(
        ...
        if image_path and ocr:
            try:
                ...
                logger.warning("[DocumentChain] OCR failed: %s", e)
        ...
        if llm:
            try:
                ...
                logger.warning("[DocumentChain] Simplification failed: %s", e)
        ...
        if target_language:
            ...
            if translator:
                try:
                    ...
                    logger.warning("[DocumentChain] Translation failed: %s", e)
        ...
        if generate_audio:
            ...
            if tts:
                try:
                    ...
                    logger.warning("[DocumentChain] TTS failed: %s", e)
