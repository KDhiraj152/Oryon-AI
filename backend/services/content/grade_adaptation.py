...
class ReadabilityLevel(StrEnum):
...
class GradeLevelAdaptationService:
    ...
    VOCABULARY_LISTS: ClassVar[dict] = {
        "very_simple": {
    ...
    def analyze_readability(self, text: str, complexity_level: int) -> dict[str, Any]:
        ...
        """
        logger.info("Analyzing readability for grade %s", complexity_level)
    ...
    def adapt_content_complexity(
        ...
        """
        logger.info("Adapting content from grade %s to %s", current_grade, target_grade)
    ...
    def validate_grade_appropriateness(
        ...
        """
        logger.info("Validating grade appropriateness: Grade %s, %s", complexity_level, subject)
