...
class SafetyGuard:
    ...
    HARMFUL_PATTERNS: ClassVar[list] = [
        # Violence
        (
    ...
    CONTENT_PATTERNS: ClassVar[list] = [
    ...
    def _get_policy_engine(self):
        ...
        if self._policy_engine is None and self._use_policy_engine:
            try:
                ...
                logger.warning("Could not get policy engine: %s", e)
    ...
    def redact_secrets(self, text: str) -> str:
        ...
        result: tuple[str, list[SecretMatch]] = self.secret_scanner.redact(text)
        return result[0]
