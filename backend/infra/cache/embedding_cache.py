...
class EmbeddingCache:
    ...
    def _get_from_db(self, key: str) -> np.ndarray | None:
        ...
        try:
            ...
            logger.warning("EmbeddingCache get error: %s", e)
            return None
    ...
    def _set_in_db(
        ...
        try:
            ...
            logger.warning("EmbeddingCache set error: %s", e)
            return False
    ...
    def _get_batch_from_db(self, keys: list[str]) -> list[np.ndarray | None]:
        ...
        try:
            ...
            logger.warning("EmbeddingCache batch get error: %s", e)
    ...
    def _set_batch_in_db(self, batch_data: list[tuple]) -> int:
        ...
        try:
            ...
            logger.warning("EmbeddingCache batch set error: %s", e)
            return 0
    ...
    def find_similar(
        ...
        try:
            ...
            logger.warning("EmbeddingCache find_similar error: %s", e)
            return []
    ...
    def cleanup(self, max_age_days: int = 30) -> int:
        ...
        try:
            ...
            conn.commit()
            conn.close()
            logger.info("[EmbeddingCache] Cleaned up %s old embeddings", count)
            return count
        except (OSError, ValueError, TypeError) as e:
            logger.warning("EmbeddingCache cleanup error: %s", e)
            return 0
