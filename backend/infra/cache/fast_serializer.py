...
class FastSerializer:
    ...
    def serialize(self, value: Any) -> bytes:
        ...
        try:
            ...
            logger.warning("Serialization error: %s, falling back to pickle", e)
    ...
    def _do_serialize(self, value: Any) -> bytes:
        ...
        if self._use_msgpack and isinstance(value, (dict, list)):
            try:
                ...
                return bytes([SerializationType.MSGPACK]) + bytes(packed)
...
class ZeroCopyBuffer:
    ...
    SIZES: ClassVar[list[int]] = [64, 256, 1024, 4096, 16384, 65536, 262144, 1048576]
...
class TypedCache:
    ...
    def encode(self, value: Any, _type_hint: type | None = None) -> bytes:
        ...
        return bytes(self._serializer.serialize(value))
...
def get_fast_serializer() -> FastSerializer:
    ...
    if _fast_serializer is not None:
